...
crazyeights-you-turn-up = Você vira { $card }.
...
crazyeights-you-win-round = Você venceu. { $details }. Você ganha { $total }.
...
crazyeights-one-card = 1 carta.

crazyeights-game-winner = { $player } wins with { $score } points.
crazyeights-you-win-game = Você venceu com { $score } pontos.

crazyeights-player-plays = { $player } plays { $card }.
crazyeights-you-play = Você joga { $card }.
crazyeights-player-draws-one = { $player } draws a card.
crazyeights-you-draw-one = Você compra uma carta.
crazyeights-player-draws-many = { $player } draws { $count } cards.
crazyeights-you-draw-many = Você compra { $count } cartas.
crazyeights-player-passes = { $player } passes.
crazyeights-you-pass = Você passa.

crazyeights-player-skipped = Pulando { $player }.
crazyeights-you-are-skipped = Você foi pulado.
