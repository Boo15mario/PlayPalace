...
crazyeights-you-turn-up = Bạn lật lên lá { $card }.
...
crazyeights-you-win-round = Bạn thắng. { $details }. Bạn được { $total } điểm.
...
crazyeights-one-card = 1 lá.

crazyeights-game-winner = { $player } thắng chung cuộc với { $score } điểm.
crazyeights-you-win-game = Bạn thắng chung cuộc với { $score } điểm.

crazyeights-player-plays = { $player } đánh lá { $card }.
crazyeights-you-play = Bạn đánh lá { $card }.
...
crazyeights-player-skipped = Bỏ qua { $player }.
crazyeights-you-are-skipped = Bạn bị bỏ qua.
